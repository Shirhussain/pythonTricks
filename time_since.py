# for more infor go to https://github.com/codingforentrepreneurs/Django-Models-Unleashed
# here you cand find that how we can make age a time since for example 'just now ' or 1 hour ago 
